...
//
// volatile long int cnt_tl = 0, cnt_tr = 0, cnt_bl = 0, cnt_br = 0;
// double th_tl = 0, th_tr = 0, th_bl = 0, th_br = 0;
//
// extern double th_tl_ref, th_tr_ref, th_bl_ref, th_br_ref;
// double kp = 10.0, ki = 5.0, kd = 0.05;
//
// PID MOT_TL_PID(&th_tl, &mot_tl_cmd, &th_tl_ref, kp, ki, kd, DIRECT);
// PID MOT_TR_PID(&th_tr, &mot_tr_cmd, &th_tr_ref, kp, ki, kd, DIRECT);
// PID MOT_BL_PID(&th_bl, &mot_bl_cmd, &th_bl_ref, kp, ki, kd, DIRECT);
// PID MOT_BR_PID(&th_br, &mot_br_cmd, &th_br_ref, kp, ki, kd, DIRECT);
//
// void init_motors() {
...
// }
// void get_angles() {
//   th_tl = cnt_tl * 360.0f / ENC_RES;
//   th_tr = cnt_tr * 360.0f / ENC_RES;
//   th_bl = cnt_bl * 360.0f / ENC_RES;
//   th_br = cnt_br * 360.0f / ENC_RES;
// }
//
// void init_pid() {
